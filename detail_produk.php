            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index.php" class="biolife-logo"><img src="admin/assets/img/Mr_DIAK.jpg" alt="biolife logo"> 
                        <b styles="font-size: 150% ; color: green;">Mr_DIAK</b></a>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 d-none d-md-block text-center">
                        <div class="primary-menu">
                            <ul>
                                ...
                                <li>
                                <li class="menu-item" href="contact.php">Hubungi Kami</a>
                            <ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-md-6 col-xs-6">
                        <div class="biolife-cart-info">
                            <div class="mobile-search">
                                <a href="javascript:void(0)" class="open-searchbox"><i class="biolife-icon icon-search">
                                <div class="mobile-search-content">
                                    <form action="#" class="form-search" name="mobile-search" method="get">
                                        <a href="#" class="btn-close"><span class="biolife-icon icon-close-menu"></span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="#" class="logo footer-logo"><img src="admin/assets/img/Mr_DIAK.jpg" alt="biolife logo" width="135" height="34"></a>
                            <div class="footer-phone-info">
                                <i class="biolife-icon icon-head-phone"></i>
                                <p class="r-info">
                                    <span>Ada Pertanyaan?</span>
                                    <span>0882-0081-36923</span>
                                </p>
                            </div>
                                ...
                                <ul class="contact-lines">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Telepon: 0882-0081-36923</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  diva6270@gmail.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                       <div class="copy-right-text"><p><a href="templateshub.net">Copyright 2025 All Right Reserves</a></p></div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
